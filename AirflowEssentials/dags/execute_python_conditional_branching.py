...
DATASETS_PATH = '/Users/bhaskarneella/airflow/datasets/insurance.csv'

OUTPUT_PATH = '/Users/bhaskarneella/airflow/output/{0}.csv'
...
with DAG(
        dag_id='executing_python_conditional_branching',
        description='Running a conditional branching pipeline',
