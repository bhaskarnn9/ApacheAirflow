...
def filter_by_region(ti):
    ...
    region_df.to_csv('/Users/bhaskarneella/airflow/output/filtered_by_region.csv', index=False)
...
def filter_bmi_smoker_charges(ti):
    ...
    selected_cols_df.to_csv('/Users/bhaskarneella/airflow/output/selected_cols.csv', index=False)
